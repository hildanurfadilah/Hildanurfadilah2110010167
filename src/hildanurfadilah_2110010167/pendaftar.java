...
public class pendaftar {
    ...
    public void setnopendaftaran(int nopendaftaran){
    ...
    public void setalamattlpn(String alamattlpn){
    this.alamattlpn=alamattlpn;
    }
    public String getalamattlpn(){
